...
{
%>
<link rel="stylesheet" type="text/css" href="/css/Admin/${param.stylepath}">
<%
}
if(scripting.equals("true"))
{
%>
<script type="text/javascript" src="/js/Admin/${param.scriptpath}"> </script>
<%
}
%>
    ...
    <div class="container-fluid">
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav me-auto mb-2 mb-lg-0">
          <li class="nav-item">
            <a class="nav-link ${param.home}" aria-current="page" href="/admin/home"><b>Home</b></a>
          </li>
          <li class="nav-item">
            <a class="nav-link ${param.professionals}" href="/admin/professionals"><b>Professionals</b></a>
          </li>
          <li class="nav-item">
            <a class="nav-link ${param.users}" href="/admin/users"><b>Users</b></a>
          </li>
        </ul>
        <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
          <li class="nav-item dropdown">
            ...
            <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
              <li><a class="dropdown-item" href="/admin/addServices">Add Services</a></li>
              <li><a class="dropdown-item" href="/admin/addCategory">Add Category</a></li>
              <li><a class="dropdown-item" href="/admin/addSubCategory">Add Sub-Category</a></li>
              <li><a class="dropdown-item" href="/admin/viewServices">View All Services</a></li>
            </ul>
          </li>
          <li class="nav-item">
            <a class="nav-link ${param.query}" href="/admin/query"><b>Queries</b></a>
          </li>
          <li class="nav-item">
            <a class="nav-link ${param.logout}" href="/logout"><b>Log Out</b></a>
          </li>
        </ul>
      </div>
    </div>
