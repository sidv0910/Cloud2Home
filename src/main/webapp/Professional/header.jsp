...
{
%>
<link rel="stylesheet" type="text/css" href="/css/Professional/${param.stylepath}">
<%
}
if(scripting.equals("true"))
{
%>
<script type="text/javascript" src="/js/Professional/${param.scriptpath}"> </script>
<%
}
%>
...
<nav class="navbar navbar-expand-lg navbar-light bg-warning">
    <div class="container-fluid">
      <a class="navbar-brand" href="/professional">
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav me-auto mb-2 mb-lg-0">
          <li class="nav-item">
            <a class="nav-link ${param.home}" aria-current="page" href="/professional/home"><b>Home</b></a>
          </li>
          <li class="nav-item">
            <a class="nav-link ${param.about}" href="/professional/about"><b>About</b></a>
          </li>
          <li class="nav-item">
            <a class="nav-link ${param.contact}" href="/professional/contact"><b>Contact</b></a>
          </li>
        </ul>
        <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
          <li class="nav-item dropdown">
            ...
            <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
              <li><a class="dropdown-item" href="/professional/profile">Profile</a></li>
              <li><a class="dropdown-item" href="/logout">Logout</a></li>
            </ul>
          </li>
          <li class="nav-item dropdown">
            <a class="nav-link dropdown-toggle ${param.appointments}" id="navbarDropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false"> <b>Appointments</b> </a>
            <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
              <li><a class="dropdown-item" href="/professional/upcoming">Upcoming Appointments</a></li>
              <li><a class="dropdown-item" href="/professional/history">Appointments History</a></li>
            </ul>
          </li>
          <li class="nav-item">
            <a class="nav-link ${param.slots}" href="/professional/slots"><b>Slots</b></a>
          </li>
        </ul>
      </div>
    </div>
