...
{
%>
<link rel="stylesheet" type="text/css" href="/css/Home/${param.stylepath}">
<%
}
if(scripting.equals("true"))
{
%>
<script type="text/javascript" src="/js/Home/${param.scriptpath}"> </script>
<%
}
%>
    ...
    <div class="container-fluid">
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav me-auto mb-2 mb-lg-0">
          <li class="nav-item">
            <a class="nav-link ${param.home}" aria-current="page" href="/home"><b>Home</b></a>
          </li>
          <li class="nav-item">
            <a class="nav-link ${param.about}" href="/about"><b>About</b></a>
          </li>
          <li class="nav-item">
            <a class="nav-link ${param.contact}" href="/contact"><b>Contact</b></a>
          </li>
        </ul>
        <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
          <li class="nav-item dropdown">
            <a class="nav-link dropdown-toggle ${param.login}" id="navbarDropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false"> <b>Login</b> </a>
            <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
              <li><a class="dropdown-item" href="/login">User Login</a></li>
              <li><a class="dropdown-item" href="/professionalLogin">Professional Login</a></li>
            </ul>
          </li>
          <li class="nav-item">
            <a class="nav-link ${param.signup}" href="/signup"><b>Sign Up</b></a>
          </li>
          <li class="nav-item">
            <a class="nav-link ${param.register}" href="/register"><b>Register As A Professional</b></a>
          </li>
        </ul>
      </div>
    </div>
