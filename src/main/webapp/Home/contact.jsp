                ...
                <form class="form-area contact-form text-right" action="/contact" method="post">
                    <div class="row">
                        <div class="col-lg-6 form-group">
                            <input type="text" name="name" maxlength="100" size="100" class="common-input mb-20 form-control" placeholder="Enter Your Name" required="required"> <br>
                            <input type="email" name="email" class="common-input mb-20 form-control" placeholder="Enter Email Address" required="required"> <br>
