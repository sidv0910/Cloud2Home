...
<jsp:include page="header.jsp">
	<jsp:param name="title" value="Professional Login" />
...
<jsp:include page="banner.jsp">
	<jsp:param name="banner" value="Professional Login" />
</jsp:include>
...
<div class="login-form">
    <form action="/professionalLogin" method="post" onsubmit="return validate();">
    	...
    	<div class="form-group input-group">
			...
			<input type="text" name="professionalId" class="form-control" placeholder="Professional ID" required="required">
		</div>
        <div class="form-group input-group">
			<div class="input-group-prepend">
    ...
    <div class="text-center small">Not Registered Yet? <a href="/register">Register As A Professional</a> here</div>
</div>
